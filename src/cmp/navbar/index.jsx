...
function ResponsiveAppBar() {
  ...
  const handlePageChange = (path) => {
    navigate(path); // Use navigate to go to the selected path
    handleCloseNavMenu(); // Close the nav menu after selection
  };
            ...
            <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
              ...
              >
                {pageLinks.map(({ name, path }) => (
                  <MenuItem key={name} onClick={() => handlePageChange(path)}>
